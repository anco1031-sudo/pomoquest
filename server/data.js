...
export const ITEMS = [
  ...
  // ใช้แล้วเรียนรู้สกิล (learn_skill) · ถ้าเรียนสกิลนั้นไปแล้ว → ยกระดับคัมภีร์ (tier +1 — พลังสกิล x1.1/ระดับ แยกจากเลเวลสกิล)
  { id: 110, name: 'คัมภีร์: ลูกไฟใหญ่', icon: '📜', type: 'scroll', learn_skill: 'sc_fireball', price: 260, desc: '✦ หายาก — ใช้แล้วเรียนรู้สกิล 🔥 ลูกไฟใหญ่ (ทุกคลาสเรียนได้) · ซ้ำ: ยกระดับคัมภีร์ (พลัง x1.1/ระดับ)' },
  { id: 111, name: 'คัมภีร์: แสงรักษา', icon: '📜', type: 'scroll', learn_skill: 'sc_heal',     price: 240, desc: '✦ หายาก — ใช้แล้วเรียนรู้สกิล 💖 แสงรักษา (ทุกคลาสเรียนได้) · ซ้ำ: ยกระดับคัมภีร์ (พลัง x1.1/ระดับ)' },
  { id: 112, name: 'คัมภีร์: สายฟ้าพิภพ', icon: '📜', type: 'scroll', learn_skill: 'sc_thunder',  price: 300, desc: '✦ หายาก — ใช้แล้วเรียนรู้สกิล ⚡ สายฟ้าพิภพ (ทุกคลาสเรียนได้) · ซ้ำ: ยกระดับคัมภีร์ (พลัง x1.1/ระดับ)' },
  { id: 113, name: 'คัมภีร์: พิษร้าย',   icon: '📜', type: 'scroll', learn_skill: 'sc_venom',    price: 280, desc: '✦ หายาก — ใช้แล้วเรียนรู้สกิล 🐍 พิษร้าย (ทุกคลาสเรียนได้) · ซ้ำ: ยกระดับคัมภีร์ (พลัง x1.1/ระดับ)' },
  { id: 114, name: 'คัมภีร์: โล่เวท',    icon: '📜', type: 'scroll', learn_skill: 'sc_guard',    price: 260, desc: '✦ หายาก — ใช้แล้วเรียนรู้สกิล 🛡️ โล่เวท (ทุกคลาสเรียนได้) · ซ้ำ: ยกระดับคัมภีร์ (พลัง x1.1/ระดับ)' },
  { id: 115, name: 'คัมภีร์: สายฟ้าแลบ', icon: '📜', type: 'scroll', learn_skill: 'sc_haste',    price: 250, desc: '✦ หายาก — ใช้แล้วเรียนรู้สกิล 🌀 สายฟ้าแลบ (ทุกคลาสเรียนได้) · ซ้ำ: ยกระดับคัมภีร์ (พลัง x1.1/ระดับ)' },

  // ---- แบบแปลนสูตรคราฟต์ (type: blueprint) — เจอจากกล่องสมบัติ/บอสเร่ร่อน (โอกาสสูงกว่าใบสกิลนิดหน่อย) ----
  // ใช้แล้วเรียนรู้สูตร (learn_recipe) · ถ้าเรียนสูตรนั้นไปแล้ว → ยกระดับสูตร (tier +1 — คราฟต์ได้ของ x tier) · ต้องมีวัสดุถึงจะคราฟต์ได้ (แท็บ 🛠️ คราฟต์ที่ค่ายพัก)
  { id: 210, name: 'แบบแปลน: ยาบำบัดใหญ่', icon: '📋', type: 'blueprint', learn_recipe: 'rc_potion_big',  price: 60,  desc: '✦ สูตรคราฟต์ — ใช้แล้วเรียนรู้การผสม ⚗️ ยาบำบัดใหญ่ · ซ้ำ: ยกระดับสูตร (คราฟต์ได้ของเพิ่มขึ้น)' },
  { id: 211, name: 'แบบแปลน: ยาฟื้นฟูเต็ม', icon: '📋', type: 'blueprint', learn_recipe: 'rc_elixir',      price: 90,  desc: '✦ สูตรคราฟต์ — ใช้แล้วเรียนรู้การผสม ✨ ยาฟื้นฟูเต็ม · ซ้ำ: ยกระดับสูตร (คราฟต์ได้ของเพิ่มขึ้น)' },
  { id: 212, name: 'แบบแปลน: เกราะมังกร',  icon: '📋', type: 'blueprint', learn_recipe: 'rc_dragon_armor', price: 180, desc: '✦ สูตรคราฟต์ — ใช้แล้วเรียนรู้การหลอม 🐲 เกราะมังกร · ซ้ำ: ยกระดับสูตร (คราฟต์ได้ของเพิ่มขึ้น)' },
  { id: 213, name: 'แบบแปลน: หมวกมังกร',   icon: '📋', type: 'blueprint', learn_recipe: 'rc_dragon_head',  price: 150, desc: '✦ สูตรคราฟต์ — ใช้แล้วเรียนรู้การหลอม ⛑️ หมวกมังกร · ซ้ำ: ยกระดับสูตร (คราฟต์ได้ของเพิ่มขึ้น)' },

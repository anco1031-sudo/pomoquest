...
export const CLASSES = {
  ...
  mage: {
    ...
    desc: 'เวทมนตร์รุนแรงที่สุด แต่ร่างกายบอบบาง — ใช้สกิลในเหตุการณ์ถี่กว่าคลาสอื่น',
...
// ----- จุดเด่น/จุดด้อยเฉพาะคลาส (ตามช่วงเวลา ☀️กลางวัน 06-17 / 🌙กลางคืน 18-05 ตามเวลาจริงของเครื่อง) -----
// monster = ตัวคูณพลังมอนสเตอร์ (ต่ำ = สู้ง่าย) · monsterW = น้ำหนัก event มอนสเตอร์
// gold/xp = % เปลี่ยนรางวัลจาก event · treasure/shrine/trap = น้ำหนัก event
// shrineReward = ตัวคูณรางวัลศาลเจ้า (XP/MP) · bossAtk = ตัวคูณดาเมจที่ทำกับบอส
// ค่าที่ไม่มีในช่วงนั้น = ปกติ (1)
export const CLASS_PERKS = {
  warrior: {
    name: 'นักรบ', icon: '⚔️',
    day:   { monster: 0.85, monsterW: 1.15, bossAtk: 1.10 },
    night: { monster: 1.15, bossAtk: 0.90 },
    perkText: {
      day:   '☀️ จุดเด่น: มอนสเตอร์อ่อนลง 15% + เจอบ่อยขึ้น · ตีบอส +10%',
      night: '🌙 จุดด้อย: มอนสเตอร์แข็งขึ้น 15% · ตีบอส -10% (ตื่นตัวน้อยยามค่ำ)',
    },
  },
  mage: {
    name: 'นักเวทย์', icon: '🔮',
    // skillUse = คูณอัตราการใช้สกิลอัตโนมัติใน event มอนสเตอร์ (ฐาน 15% — เวทย์ใช้เวทถี่กว่าคลาสอื่น 2.5x)
    day:   { xp: -0.10, bossAtk: 0.90, skillUse: 2.5 },
    night: { xp: 0.25, bossAtk: 1.10, skillUse: 2.5 },
    perkText: {
      day:   '☀️ จุดด้อย: XP -10% (พลังจันทราเสื่อม) · ตีบอส -10% — 🔮 ใช้สกิลในเหตุการณ์ถี่กว่าคลาสอื่น',
      night: '🌙 จุดเด่น: XP +25% (พลังจันทราเต็มเปี่ยม) · ตีบอส +10% — 🔮 ใช้สกิลในเหตุการณ์ถี่กว่าคลาสอื่น',
    },
  },
  rogue: {
    name: 'โจร', icon: '🗡️',
    night: { gold: 0.30, treasure: 1.25, trap: 1.30, bossAtk: 1.10 },
    perkText: {
      night: '🌙 กลางคืน: ทอง +30% · เจอสมบัติ x1.25 · ตีบอส +10% — แต่กับดักถี่ขึ้น x1.3 (มืดมองไม่เห็น!)',
    },
  },
  cleric: {
    name: 'นักบวช', icon: '✨',
    day:   { shrine: 1.25, shrineReward: 1.25, bossAtk: 1.10 },
    night: { monster: 1.10 },
    perkText: {
      day:   '☀️ จุดเด่น: ศาลเจ้า ⛩️ ถี่ขึ้น x1.25 + รางวัล +25% · ตีบอส +10%',
      night: '🌙 จุดด้อย: มอนสเตอร์แข็งขึ้น 10% (ศรัทธาอ่อนยามค่ำ)',
    },
  },
};
...
export const ITEMS = [
  ...
  { id: 128, name: 'ใยแมงมุม',     icon: '🕸️', type: 'junk', price: 8,  desc: 'ใยเหนียวหนึบของแมงมุมพิษ พ่อค้ารับซื้อ' },
  { id: 129, name: 'เขี้ยวหมูป่า',  icon: '🐗', type: 'junk', price: 11, desc: 'เขี้ยวเงินวาวของหมูป่าเขี้ยวเงิน ขายได้นิดหน่อย' },
  { id: 142, name: 'เศษกระดูก',    icon: '🧟', type: 'junk', price: 13, desc: 'กระดูกเก่าแก่ของโครงกระดูก พ่อค้าชอบของแปลก' },
  { id: 143, name: 'เศษผ้าผี',     icon: '👻', type: 'junk', price: 15, desc: 'เศษผ้าขาดวิ่นของผีหลอก เอาไปขายได้ราคา' },
  { id: 144, name: 'เหล็กในแมงป่อง', icon: '🦂', type: 'junk', price: 18, desc: 'เหล็กในพิษสงของแมงป่องทราย ใช้ทำยาได้' },
  { id: 145, name: 'เขี้ยวแวมไพร์', icon: '🧛', type: 'junk', price: 25, desc: 'เขี้ยวคมกริบของแวมไพร์น้อย ขายได้ราคาดี' },

  // ---- ของขวัญประจำเมือง (loot ของมอนสเตอร์พิเศษประจำเมือง — exclusive ไม่ดรอปตามปกติ ชนะตัวประจำเมือง ~60%) ----
  { id: 146, name: 'เขากวางทอง',    icon: '🦌', type: 'junk', price: 45, exclusive: true, desc: '✦ เขากวางเรืองแสงทองของกวางเขาทอง นักสะสมอยากได้' },
  { id: 147, name: 'ของมีค่าขโมยมา', icon: '🦝', type: 'junk', price: 50, exclusive: true, desc: '✦ ของที่แรคคูนนักขโมยแอบซ่อนไว้ เอาไปคืนได้ค่าหัว' },
  { id: 148, name: 'หนวดปลาหมึกยักษ์', icon: '🦑', type: 'junk', price: 55, exclusive: true, desc: '✦ หนวดเหนียวหนึบของปลาหมึกยักษ์ พ่อค้ารับซื้อ' },
  { id: 149, name: 'ฝุ่นนางฟ้า',     icon: '🧚', type: 'junk', price: 60, exclusive: true, desc: '✦ ฝุ่นเรืองแสงของเอลฟ์ป่าลึกลับ ของแปลกขายได้ราคา' },
  { id: 163, name: 'เกล็ดเพลิง',     icon: '🦎', type: 'junk', price: 65, exclusive: true, desc: '✦ เกล็ดร้อนระอุของซาลาแมนเดอร์เพลิง ใช้ทำเครื่องมือได้' },
  { id: 164, name: 'เศษคริสตัลบริสุทธิ์', icon: '🦔', type: 'junk', price: 70, exclusive: true, desc: '✦ คริสตัลจากหนามเม่นคริสตัล สวยงามน่าเก็บ' },
  { id: 165, name: 'ขนเพนกวินอัศวิน', icon: '🐧', type: 'junk', price: 75, exclusive: true, desc: '✦ ขนหนานุ่มของเพนกวินอัศวิน ขายได้ราคาดี' },
  { id: 166, name: 'ขนนกกริฟฟิน',   icon: '🦅', type: 'junk', price: 80, exclusive: true, desc: '✦ ขนสีทองของกริฟฟินราชันย์ ล้ำค่า' },
  { id: 167, name: 'ต่อมพิษมรกต',   icon: '🐸', type: 'junk', price: 85, exclusive: true, desc: '✦ ต่อมพิษสีมรกตของกบมรกตยักษ์ ใช้ทำยาได้' },
  { id: 168, name: 'ขนนกสายฟ้า',    icon: '🐦', type: 'junk', price: 90, exclusive: true, desc: '✦ ขนที่ประจุไฟฟ้าของวิหคสายฟ้า พ่อค้าชอบของแปลก' },
  { id: 169, name: 'เกล็ดงูทราย',   icon: '🐍', type: 'junk', price: 95, exclusive: true, desc: '✦ เกล็ดทรายสีทองของงูจ้าวทราย' },
  { id: 172, name: 'ฟันไทแรนโนซอรัส', icon: '🦖', type: 'junk', price: 100, exclusive: true, desc: '✦ ฟันใหญ่โบราณของไทแรนโนซอรัสทอง ของในตำนาน' },
  ...
  // ---- ของขวัญพิเศษจาก 🌟 จ้าวมังกรทอง (monster พิเศษหายากมาก — ชนะแล้วได้การันตี 1 ชิ้น, ไม่ดรอปตามปกติ) ----
  { id: 190, name: 'ถ้วยจ้าวมังกรทอง', icon: '🏆', type: 'junk', price: 500, exclusive: true, desc: '✦ ของขวัญจากจ้าวมังกรทอง — ถ้วยหล่อทองบริสุทธิ์ นักสะสมยอมจ่ายแพง' },
  { id: 191, name: 'หัวใจมังกรทอง',   icon: '💛', type: 'junk', price: 650, exclusive: true, desc: '✦ ของขวัญจากจ้าวมังกรทอง — หัวใจที่ยังเต้นด้วยพลังทอง ล้ำค่าที่สุด' },
  { id: 192, name: 'มงกุฎจ้าวมังกร',  icon: '👑', type: 'junk', price: 800, exclusive: true, desc: '✦ ของขวัญจากจ้าวมังกรทอง — มงกุฎประจำราชวงศ์มังกรทอง ของในตำนาน' },
  // 🎁 ของขวัญจ้าวมังกรทอง — ชนะจ้าวมังกรทองแล้วได้การันตี · เปิดที่ค่ายพักได้ (สุ่มของด้านใน: 🏆/💛/👑/ถุงทอง)
  { id: 193, name: 'ของขวัญจ้าวมังกรทอง', icon: '🎁', type: 'consumable', use_gift: 1, price: 0, exclusive: true, desc: '✦ ของขวัญจากจ้าวมังกรทอง — เปิดที่ค่ายพักได้! สุ่มรางวัล: 🏆 ถ้วย 500ท / 💛 หัวใจ 650ท / 👑 มงกุฎ 800ท / หรือถุงทอง 250ท' },
...
// ult = สไตล์ท่าไม้ตาย (ชาร์จพลัง) ของบอส — ดู BOSS_ULTS ข้างล่าง
// แต่ละบอสมีท่าไม้ตายต่างกัน: 💥 ท่าไม้ตาย (โจมตีมหึมา) · 🛡️ เกราะมหึมา (กันดาเมจ) · 💚 พลังฟื้นฟู (ฟื้น HP) · 💨 เงามายา (หลบโจมตี)
export const BOSSES = [
  { name: 'หัวหน้าโจรป่า', icon: '🐗', loot: 130, ult: 'smash' },
  { name: 'กัปตันทหารรับจ้าง', icon: '⚔️', loot: 131, ult: 'smash' },
  { name: 'แม่ทัพเงาแห่งท่าเรือ', icon: '🗡️', loot: 132, ult: 'dodge' },
  { name: 'ราชินีแม่มด', icon: '🧙', loot: 133, ult: 'regen' },
  { name: 'โกลเลมไฟ', icon: '🔥', loot: 134, ult: 'shield' },
  { name: 'คริสตัลการ์เดี้ยน', icon: '🔮', loot: 135, ult: 'shield' },
  { name: 'มังกรน้ำแข็ง', icon: '🐉', loot: 136, ult: 'smash' },
  { name: 'จอมมารเงา', icon: '👹', loot: 137, ult: 'dodge' },
  { name: 'ราชามรกต', icon: '💚', loot: 138, ult: 'regen' },
  { name: 'ราชินีพายุ', icon: '⚡', loot: 139, ult: 'smash' },
  { name: 'ทรายดูดยักษ์', icon: '🐍', loot: 140, ult: 'dodge' },
  { name: 'ราชามังกร', icon: '🐲', loot: 141, ult: 'smash' },
];
...
// ----- บอสจ้าวมังกรทอง 🌟 — สุ่มเจอแทนบอสปกติของเมือง (~4% — DRAGON_BOSS_CHANCE ใน game.js) -----
// แรงกว่าบอสเมืองมาก (em x1.5) · ชนะแล้วได้ 🎁 ของขวัญจ้าวมังกรทอง 2 กล่องการันตี + รางวัล x1.5
// แพ้ (ถอยทัพ) → เสียของสุ่ม 1 ชิ้น + ทอง 10% + คอมโบโฟกัส + HP เหลือ 1 (มังกรไม่ปล่อยง่าย ๆ)
export const GOLDEN_DRAGON_BOSS = {
  name: 'จ้าวมังกรทอง', icon: '🌟', ult: 'smash', loot: null,
  hint: 'มังกรทองในตำนาน — แข็งแกร่งเกินคำบรรยาย แต่รางวัลยิ่งใหญ่! ชนะแล้วได้ของขวัญการันตี 2 กล่อง',
};

// ----- ท่าไม้ตายของบอส (ชาร์จพลัง) — แต่ละบอสมีสไตล์ต่างกัน -----
// ทุกบอสชาร์จเหมือนกัน (ทุก 5 เทิร์น สลายได้ด้วยดาเมจ ≥12% HP สูงสุด) แต่ตอนปล่อย
// ออกมา เอฟเฟกต์ต่างกันตาม ult ของบอสตัวนั้น:
//  - smash  = 💥 โจมตีมหึมา x2.6 (ดาเมจตรง ๆ — ตั้งรับ/หลบได้)
//  - shield = 🛡️ เกราะมหึมา — ลดดาเมจที่บอสได้รับ 60% (guard = ตัวคูณดาเมจที่เหลือ) เป็นเวลา 2 เทิร์น
//  - regen  = 💚 พลังฟื้นฟู — ฟื้น HP 40% ของ HP สูงสุดทันที
//  - dodge  = 💨 เงามายา — บอสหลบโจมตีผู้เล่นได้ (โอกาส 50%) เป็นเวลา 2 เทิร์น
// guard = ตัวคูณดาเมจที่บอสได้รับตอนเกราะติด (0.4 = เหลือ 40% = ลด 60%)
export const BOSS_ULTS = {
  smash:  { name: 'ท่าไม้ตาย',   icon: '💥', type: 'attack', mult: 2.6,  desc: 'โจมตีมหึมา x2.6' },
  shield: { name: 'เกราะมหึมา', icon: '🛡️', type: 'shield', guard: 0.4, turns: 2, desc: 'ลดดาเมจที่บอสได้รับ 60% (2 เทิร์น)' },
  regen:  { name: 'พลังฟื้นฟู',  icon: '💚', type: 'heal',   heal: 0.4, desc: 'ฟื้น HP 40%' },
  dodge:  { name: 'เงามายา',    icon: '💨', type: 'dodge',  dodge: 0.5, turns: 2, desc: 'หลบโจมตีของคุณ 50% (2 เทิร์น)' },
};
...
// rare: true = มอนสเตอร์พิเศษ 🌟 — เจอได้ยากมาก (rollMonster ตรวจ ~1% ของการเจอมอนสเตอร์)
//   loot = 🎁 ของขวัญ (เปิดที่ค่ายได้) — ชนะแล้วได้การันตี · giftContents = ของที่สุ่มได้เมื่อเปิด (โชว์ในคู่มือล่า)
export const MONSTERS = [
  ...
  { name: 'แมงมุมพิษ',   icon: '🕷️', power: 0.95, xp: 21, gold: 13, loot: 128 },
  { name: 'หมาป่าเถื่อน', icon: '🐺', power: 1.0,  xp: 24, gold: 14, loot: 122 },
  { name: 'หมูป่าเขี้ยวเงิน', icon: '🐗', power: 1.05, xp: 26, gold: 16, loot: 129 },
  { name: 'โกเลมดิน',    icon: '🗿', power: 1.15, xp: 30, gold: 18, loot: 124 },
  { name: 'โครงกระดูก',  icon: '🧟', power: 1.2,  xp: 33, gold: 20, loot: 142 },
  { name: 'แม่มดน้อย',   icon: '🧙‍♀️', power: 1.25, xp: 36, gold: 22, loot: 125 },
  { name: 'ผีหลอก',      icon: '👻', power: 1.3,  xp: 39, gold: 24, loot: 143 },
  { name: 'อสูรเงา',     icon: '👤', power: 1.35, xp: 42, gold: 26, loot: 126 },
  { name: 'แมงป่องทราย', icon: '🦂', power: 1.4,  xp: 45, gold: 28, loot: 144 },
  { name: 'มังกรน้อย',   icon: '🐲', power: 1.5,  xp: 55, gold: 35, loot: 127 },
  { name: 'แวมไพร์น้อย', icon: '🧛', power: 1.55, xp: 58, gold: 36, loot: 145 },
  // 🌟 มอนสเตอร์พิเศษ — เจอได้ยากมาก (~1% ของการเจอมอนสเตอร์) แรงที่สุดในเกม ชนะแล้วได้ 🎁 ของขวัญการันตี (เปิดที่ค่าย)
  {
    name: 'จ้าวมังกรทอง', icon: '🌟', power: 2.2, xp: 120, gold: 90, rare: true,
    loot: 193, // 🎁 ของขวัญจ้าวมังกรทอง — ชนะแล้วได้การันตี เปิดที่ค่ายพักได้ (สุ่มของด้านใน)
    giftContents: [190, 191, 192], // ของที่สุ่มได้เมื่อเปิดของขวัญ (โชว์ในคู่มือล่า)
    flavor: 'แสงสีทองสาดส่องทั้งผืนป่า — {monster} ในตำนานปรากฏกาย! เจอได้ยากยิ่งนัก แต่นี่คือโอกาสครั้งเดียวในชีวิต!',
  },
];

// ----- มอนสเตอร์พิเศษประจำเมือง (index ตรงกับ CITIES) — เจอได้ยาก (~2% ของการเจอมอนสเตอร์ — rollMonster) -----
// เฉพาะเมืองที่ตัวละครอยู่ (เมืองไกล เจอตัวที่แข็งกว่า) · ดรอปของขวัญประจำเมือง (loot — exclusive ขายได้) ตอนชนะ ~60%
// แรงกว่ามอนสเตอร์ทั่วไป แต่รองจาก 🌟 จ้าวมังกรทอง
export const CITY_MONSTERS = [
  { name: 'กวางเขาทอง',       icon: '🦌', power: 1.7,  xp: 70,  gold: 40, loot: 146, flavor: 'เขากวางเรืองแสงทองส่องผ่านพุ่มไม้ — {monster} แห่งทุ่งหญ้าอีสตาร์ปรากฏกาย!' },
  { name: 'แรคคูนนักขโมย',     icon: '🦝', power: 1.75, xp: 75,  gold: 42, loot: 147, flavor: 'ของมีค่าหายวับไปต่อหน้าต่อตา — {monster} แห่งตลาดมิราเคิลหัวเราะคิก ๆ!' },
  { name: 'ปลาหมึกยักษ์',      icon: '🦑', power: 1.8,  xp: 80,  gold: 44, loot: 148, flavor: 'หนวดยักษ์พุ่งขึ้นจากทะเล — {monster} แห่งท่าเรือธาราขวางทางอยู่!' },
  { name: 'เอลฟ์ป่าลึกลับ',     icon: '🧚', power: 1.85, xp: 85,  gold: 46, loot: 149, flavor: 'เสียงหัวเราะระริกกลางป่าอาร์คานา — {monster} เล่นซ่อนแอบกับคุณ!' },
  { name: 'ซาลาแมนเดอร์เพลิง', icon: '🦎', power: 1.9,  xp: 90,  gold: 48, loot: 163, flavor: 'ไอร้อนลวกผิวจากรอยแยกภูเขาไฟ — {monster} แห่งเทือกเขาอัคนี!' },
  { name: 'เม่นคริสตัล',       icon: '🦔', power: 1.95, xp: 95,  gold: 50, loot: 164, flavor: 'แสงระยิบจากหนามคริสตัล — {monster} แห่งเมืองคริสตัลกลิ้งเข้ามา!' },
  { name: 'เพนกวินอัศวิน',     icon: '🐧', power: 2.0,  xp: 100, gold: 52, loot: 165, flavor: 'ท่าทางเชิดหน้าข้ามหิมะมา — {monster} แห่งดินแดนน้ำแข็งท้าสู้!' },
  { name: 'กริฟฟินราชันย์',     icon: '🦅', power: 2.05, xp: 105, gold: 54, loot: 166, flavor: 'เงาปีกกว้างบดบังแสง — {monster} แห่งแอสการ์ดโฉบลงมา!' },
  { name: 'กบมรกตยักษ์',       icon: '🐸', power: 2.05, xp: 110, gold: 56, loot: 167, flavor: 'เสียงร้องก้องกังวานทั้งหุบเขา — {monster} แห่งหุบเขามรกต!' },
  { name: 'วิหคสายฟ้า',        icon: '🐦', power: 2.1,  xp: 115, gold: 58, loot: 168, flavor: 'สายฟ้าแลบแปลบเหนือเมือง — {monster} แห่งนครสายฟ้าร้องกู่!' },
  { name: 'งูจ้าวทราย',        icon: '🐍', power: 2.1,  xp: 120, gold: 60, loot: 169, flavor: 'ทรายทะเลทรายพลุ่งเป็นคลื่น — {monster} แห่งทะเลทรายนิรันดร์ผงาด!' },
  { name: 'ไทแรนโนซอรัสทอง',  icon: '🦖', power: 2.15, xp: 125, gold: 62, loot: 172, flavor: 'เสียงคำรามสั่นสะเทือนอาณาจักร — {monster} แห่งอาณาจักรมังกร!' },
];
...
export const EVENT_POOL = [
  ...
  },
  {
    key: 'egg', weight: 1,
    title: '🥚 ไข่ปริศนา!',
    flavor: 'เสียงกะเทาะเปลือกดังมาจากใต้พุ่มไม้… ไข่ปริศนาที่มีแสงเรืองรอง!',
  },
];
...
export const PET_EGG_ID = 170;        // 🥚 ไข่ปริศนา — ใช้แล้วฟักเป็นสัตว์เลี้ยง
// สุ่ม pet ตอนฟักไข่ — ตาม rarity (ทั่วไป 60% / หายาก 28% / หายากมาก 10% / ตำนาน 2%)
export const PET_RARITY_ROLL = [
...
// ----- สัตว์เลี้ยง (Pet) — ฟักจาก 🥚 ไข่ปริศนา (ดรอปหายากจากสมบัติ/event พิเศษ) -----
// ค่าพิเศษเฉพาะตัว: gold/xp = % เพิ่มจากเหตุการณ์ · monster/treasure/shrine = น้ำหนัก event · trap = น้ำหนักกับดัก
//   steal = แมวซนขโมยของกลับมาได้ 40% ตอนตกกับดัก · trapShield = ยูนิคอร์นกันกับดัก 1 ครั้ง/รอบ
// ค่าพิเศษแรงขึ้น +10%/เลเวลของ pet (Lv.10 = x2) · moods = ฟองอารมณ์ตามวันไม่ได้โฟกัส (0=สดใส → 3=เบื่อมาก)
export const PETS = [
  {
    id: 'p_hamster', name: 'หนูแฮมสเตอร์', icon: '🐹', rarity: 'common', gold: 0.05,
    desc: '+5% ทองจากเหตุการณ์ (Lv.1) — ตัวเล็ก ๆ แต่ขยันเก็บทอง',
    moods: ['😄 วิ่งวงล้ออย่างมีความสุข', '🙂 กินเมล็ดพืชเพลิน ๆ', '😐 แอบเบื่อในกรง', '🥺 ตัวเล็ก ๆ เหงา ๆ รอคุณอยู่'],
  },
  {
    id: 'p_chick', name: 'ลูกเจี๊ยบ', icon: '🐥', rarity: 'common', xp: 0.05,
    desc: '+5% XP จากเหตุการณ์ (Lv.1) — เจี๊ยบ ๆ ปลุกพลังให้คุณ',
    moods: ['😄 เจี๊ยบ ๆ ร้องเพลงสดใส', '🙂 จิกเมล็ดข้าวเพลิน ๆ', '😐 เจี๊ยบเบา ๆ เหงา ๆ', '🥺 เจี๊ยบ… เจี๊ยบ… รอใครสักคน'],
  },
  {
    id: 'p_fox', name: 'จิ้งจอกเงิน', icon: '🦊', rarity: 'rare', gold: 0.12,
    desc: '+12% ทองจากเหตุการณ์ (Lv.1) — เจ้าเล่ห์ ชอบทอง',
    moods: ['😄 ขนเงินวาววับ ส่ายหางให้', '🙂 ย่องเงียบ ๆ หาของมีค่า', '😐 หางตก ๆ เริ่มเบื่อ', '🥺 จิ้งจอกเหงา นั่งมองจันทร์'],
  },
  {
    id: 'p_owl', name: 'นกฮูกจอมยุทธ์', icon: '🦉', rarity: 'rare', monster: 1.25,
    desc: 'เจอมอนสเตอร์ถี่ขึ้น x1.25 (Lv.1) — เลเวลไวขึ้น แต่เสี่ยงขึ้น',
    moods: ['😄 ฮูก ๆ กระตือรือร้นออกล่า', '🙂 เกาะกิ่งไม้มองไกล ๆ', '😐 กระพือปีกช้า ๆ เบื่อ', '🥺 ฮูก…ฮูก… รอเจ้านายกลับมา'],
  },
  {
    id: 'p_boa', name: 'งูเหลือมทอง', icon: '🐍', rarity: 'rare', gold: 0.08, xp: 0.08,
    desc: '+8% ทอง +8% XP จากเหตุการณ์ (Lv.1) — งูทองนำโชค',
    moods: ['😄 เลื้อยเป็นวงสวยงาม', '🙂 อาบแดดยามเช้า', '😐 ขดตัวนิ่ง ๆ เบื่อ', '🥺 งูทองเหงา ขดรอเจ้านาย'],
  },
  {
    id: 'p_cat', name: 'แมวซน', icon: '🐈', rarity: 'rare', trap: 1.5, steal: 0.4,
    desc: 'เจอกับดักถี่ x1.5 (gimmick!) — แต่ตกกับดัก 40% แอบขโมยของกลับมาได้',
    moods: ['😄 กระโดดโลดเต้นซนสุด ๆ', '🙂 นอนกลิ้งรับแดดอ่อน ๆ', '😐 เริ่มงอแงอยากได้ขนม', '🥺 เมี้ยว… เมี้ยว… คิดถึงคุณ'],
  },
  {
    id: 'p_dragon', name: 'มังกรน้อย', icon: '🐉', rarity: 'epic', gold: 0.2, treasure: 1.3,
    desc: '+20% ทอง + เจอสมบัติบ่อยขึ้น x1.3 (Lv.1) — มังกรทองตัวน้อย',
    moods: ['😄 พ่นไฟเล็ก ๆ อย่างตื่นเต้น', '🙂 กางปีกบินวนรอบตัวคุณ', '😐 ครางเบา ๆ เริ่มง่วง', '🥺 มังกรน้อยพ่นควันเศร้า ๆ'],
  },
  {
    id: 'p_unicorn', name: 'ยูนิคอร์น', icon: '🦄', rarity: 'legend', gold: 0.15, xp: 0.15, shrine: 1.3, trapShield: 1,
    desc: '+15% ทอง/XP + เจอศาลเจ้าถี่ขึ้น + กันกับดัก 1 ครั้ง/รอบ (Lv.1) — ม้าแห่งตำนาน',
    moods: ['😄 แสงสีรุ้งเปล่งรอบกาย', '🙂 แตะเขาเรืองแสงอย่างอ่อนโยน', '😐 แสงเริ่มหรี่ลง เศร้า ๆ', '🥺 ยูนิคอร์นร้องเบา ๆ คิดถึงเจ้านาย'],
  },
];
...
export const DAILY_QUESTS = [
  ...
  { id: 'dq_city_monster',  name: 'นักล่าตำนานเมือง', icon: '🗺️', key: 'city_monsters', target: () => 1, desc: 'ชนะมอนสเตอร์ประจำเมือง {n} ตัววันนี้ (เจอได้ยาก ~2% เฉพาะเมืองที่คุณอยู่ — ลุ้นกันหน่อย!)', unit: 'count' },
...
export const SECRET_ACHIEVEMENTS = [
  ...
  // มอนสเตอร์พิเศษ: ชนะ 🌟 จ้าวมังกรทอง (เจอได้ยากมาก ~1%) / 🏙️ ตัวประจำเมือง (เจอ ~2% เฉพาะเมืองนั้น)
  { id: 'dragon_hunter',  name: 'นักล่าตำนาน',      icon: '🌟', hint: 'แสงสีทองสาดส่องกลางป่า… ใครกันที่กล้าเผชิญหน้ากับตำนาน?', reward: { gold: 300 }, check: (ctx) => ctx.rareWins >= 1 },
  { id: 'dragon_king',    name: 'ราชันย์นักล่าตำนาน', icon: '👑', hint: 'ตำนานไม่เคยตาย มันแค่รอคอยผู้ที่คู่ควร…',        reward: { gold: 800 }, check: (ctx) => ctx.rareWins >= 3 },
  { id: 'city_hunter',    name: 'นักล่าประจำเมือง',  icon: '🗺️', hint: 'ทุกเมืองมีตำนานของมันเอง… ไปทำความรู้จักพวกมัน',     reward: { gold: 400 }, check: (ctx) => ctx.cityWins >= 3 },

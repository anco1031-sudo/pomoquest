...
### ระบบหลัก
- 🧑‍🎤 **สร้างตัวละครหลายตัว** — เลือกชื่อ + 1 ใน 4 คลาส (นักรบ / นักเวทย์ / โจร / นักบวช) สร้างได้หลายตัว สลับเล่นได้ เปลี่ยนชื่อได้ ลบได้ (ปุ่ม 👥) แต่ละตัวมี progress/ไอเทม/timer แยกกัน

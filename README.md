...
|---|---|
| **Work session (25 นาที)** | ⚔️ ผจญภัยในเมืองปัจจุบัน — ทุก 30–90 วินาที (สุ่ม) จะเกิดเหตุการณ์สุ่ม: เจอมอนสเตอร์ (สู้แบบอัตโนมัติ ไม่รบกวนสมาธิ) เจอสมบัติ ศาลเจ้าลึกลับ พ่อค้าเร่ร่อน หรือกับดัก |

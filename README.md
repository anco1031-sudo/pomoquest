...
- 📅 **Daily Quest (ภารกิจประจำวัน)** — สุ่ม 3 ภารกิจต่อวัน (รีเซ็ตเที่ยงคืน) เช่น โฟกัสครบ 2 session, กำจัดมอนสเตอร์ 5 ตัว, ชนะบอส 1 ตัว — ทำเสร็จรับรางวัลทอง/XP และทำครบทุกภารกิจได้โบนัสพิเศษ (ทอง + XP + ไอเทม)
